...
| App scaffold              | Started     | PR 2 adds app workspace, tooling, CI, and shell. |
| Domain schemas            | Not started | Planned for PR 3.                                |
| Projection engine         | Not started | Planned for PR 4.                                |
